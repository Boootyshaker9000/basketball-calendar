...
/// <summary>
/// Form for selecting a color theme based on an NBA team.
/// </summary>
public partial class SettingsForm : Form
{
    /// <summary>
    /// Gets the selected primary color.
    /// </summary>
    public Color SelectedPrimary { get; private set; }

    /// <summary>
    /// Gets the selected secondary color.
    /// </summary>
    public Color SelectedSecondary { get; private set; }

    /// <summary>
    /// Dictionary mapping NBA team names to their primary and secondary colors.
    /// </summary>
    ...
    /// Populates the team combo box with available team names.
    /// </summary>
    public SettingsForm()
    {
        InitializeComponent();
    ...
    /// <summary>
    /// Handles the SelectedIndexChanged event of the team combo box.
    /// Updates the preview panels to show the primary and secondary colors for the selected team.
    /// </summary>
    ...
    /// Saves the selected team colors to settings and writes them to "settings.json".
    /// </summary>
    ...
    /// <summary>
    /// Applies the specified foreground and background colors to all controls on the form.
    /// </summary>
